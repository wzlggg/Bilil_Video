    ...
    <div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
        ...
        <div class="off-canvas position-left light-off-menu" id="offCanvas-responsive" data-off-canvas>
            ...
            <ul class="vertical menu off-menu" data-responsive-menu="drilldown">
                ...
                <li>
                    <a href="blog.html"><i class="fa fa-edit"></i>个人主页</a>
                    <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                        <li><a href="blog-single-post.html"><i class="fa fa-edit"></i>blog single post</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-magic"></i>功能</a>
                    <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-magic"></i>简介</a>
                            <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
            ...
            <div class="top-button">
                <ul class="menu">
                    <li>
                        <a href="submit-post.html">上传视频</a>
                    </li>
                                ...
                                <ul class="menu float-right">
                                    ...
                                    <li class="dropdown-login">
                                        ...
                                        <div class="login-form">
                                            ...
                                            <p class="text-center">第一次来? <a class="newaccount" href="login-register.html">创建新账号</a></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="large-12 columns">
                        <nav aria-label="You are here:" role="navigation">
                            <ul class="breadcrumbs">
                                ...
                                <li><a href="#">简介</a></li>
                                <li>
                                    <span class="show-for-sr">现在: </span> 上传视频
                                </li>
                            </ul>
                        </nav>
                    </div>
                        ...
                        <div class="large-12 columns">
                            ...
                            <div class="profile-share">
                                <div class="easy-share" data-easyshare data-easyshare-http data-easyshare-url="http://joinwebs.com">
                                    ...
                                    <div data-easyshare-loader>载入...</div>
                                </div>
                            </div>
                            <div class="clearfix">
                                    ...
                                    <div class="large-12 columns">
                                        ...
                                        <form data-abide novalidate>
                                            ...
                                            <div class="row">
                                                <div class="large-12 columns">
                                                    <label>Title
                                                        <input type="text" name="videoName" placeholder="输入视频名字..." required>
                                               ...
                                               <!-- <div class="large-12 columns">
                                                ...
                                                <div class="large-12 columns">
                                                    ...
                                                    <div class="upload-video">
                                                        <label for="videoUpload" class="button">上传视频</label>
                                                ...
                                                <div class="large-12 columns">
                                                    <button class="button expanded" type="submit" name="submit">现在发表</button>
                                                </div>
                                            </div>
                                        </form>

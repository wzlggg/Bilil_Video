...
<form action="system/updateMyUser" id="f1" method="post" class="form-horizontal">
		<h5 class="page-header alert-info"
			...
			<input type="hidden" name="userId" value="${usersInfo.userId }" />
		<!-- 开始1 -->
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" required name="userName" value="${usersInfo.userName }" placeholder="请输入用户姓名" />
					</div>
				</div>
			</div>
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" name="userAge" value="${usersInfo.userAge }" placeholder="请输入用户年龄" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" name="userPhone" value="${usersInfo.userPhone }" placeholder="请输入电话号码" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-4 ">
						 <p class="form-control-static">${usersInfo.roleName}</p>
						<input type="hidden" name="roleName" value="${usersInfo.roleName}">
					</div>
				</div>
			</div>
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						 <p class="form-control-static">${usersInfo.userSalary}</p>
					<input type="hidden" name="userSalary"  readonly="readonly" value="${usersInfo.userSalary}">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9">
					 <p class="form-control-static">${usersInfo.userAccount}</p>
						<input type="hidden" name="userAccount"  value="${usersInfo.userAccount}">
					</div>
				</div>
			</div>
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control"  value="${usersInfo.userPwd }"  required name="userPwd" placeholder="请输入用户密码" />
					</div>
				</div>
			</div>
		</div>

							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<div class="space-6"></div>
										<form action="system/BackgroundAction_login" method="post" id="loginForm" onsubmit="return check()">
												
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input id="playUserName"
													required="required"	name="playUserName" type="text" class="form-control"
														placeholder="请输入账号" value="${user.userAccount }" /> <i class="icon-user"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input id="playUserPassword"
													required="required"	name="playUserPassword" type="password" class="form-control"

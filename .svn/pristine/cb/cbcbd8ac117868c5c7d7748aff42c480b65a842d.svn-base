				...
				<ul class="nav ace-nav">
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							...
							class="user-info"> <small>欢迎光临,${usersInfo.playUserName }</small>
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a
						href="system/PlayUserAction_indexUI" target="mainframe">
									...
									<ul class="submenu">
										<c:forEach var="child" items="${menus }">
											<c:if test="${child.pMenuId==menu.menuId }">
					                            <li><a href="${child.menuUrl }" target="mainframe"> <i
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="system/PlayUserAction_indexUI"

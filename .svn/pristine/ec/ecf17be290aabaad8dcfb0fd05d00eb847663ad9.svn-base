		...
		<div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
			...
			<div class="off-canvas-content" data-off-canvas-content>
						...
						<div class="large-12 columns">
							<nav aria-label="You are here:" role="navigation">
								<ul class="breadcrumbs">
									...
									<li><a href="">视频</a></li>
									<li><span class="show-for-sr">现在: </span> 萌宠</li>
								</ul>
							</nav>
						</div>
					</div>
				...
				<section class="fullwidth-single-video">
					<h5>
						<a style="display:block;text-align:center">${vedio.vedioName }</a>
					</h5>
					<div class="row">
						<div class="large-12 columns">
										...
										<div class="row padding-14">
											<div class="medium-12 small-12 columns">
												<div class="head-title">
													...
													<h4>
		        										评论 <span>(${vedioRemarkCountInfo} )</span>
													</h4>
												</div>
											</div>
										</div>
                                    ...
                                    <div class="media-object stack-for-small">
                                        <div class="media-object-section comment-img text-center">
                                            <div class="comment-box-img">
                                                <img src= "${userInfo.playUserHead }" alt="comment">
                                            </div>
                                            <h6><a href="#">${userInfo.playUserName }</a></h6>
                                        </div>
                                        <div class="media-object-section comment-textarea">
                                        <%-- 提交评论 --%>
                                            <form method="post" action="system/RemarkAction_addRemark">
                                            <input type="text" name="remarkContent" placeholder="添加一条评论..."/>
                                                <input type="submit" name="submit" value="发送">
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                	<s:action name="RemarkAction_showRemarkByVedioId" namespace="/system"></s:action>
								<!-- main comment -->
									...
									<div class="media-object stack-for-small reply-comment">
										...
										<div class="media-object-section comment-desc">
											<div class="comment-title">
												<span class="name"> ${remark.playUser.getPlayUserName()} </a> 评论:</span>
												<span class="time float-right"><i
													class="fa fa-clock-o"></i>${remark.remarkTime}</span>
											</div>
											<div class="comment-text">
												<p>${remark.remarkContent}</p>
											</div>
										</div>
									</div>
								</div>
